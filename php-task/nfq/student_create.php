...
<div class="form-group">
    <label for="formGroupExampleInput">Student Name</label><br>
    <input name="student-name" type="text" class="form-control" id="formGroupExampleInput" placeholder="Student Name">
</div>
